      ...
      <Paper elevation={3} sx={{ p: 4, mt: 4, borderRadius: '12px' }}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} align="center">
            <div ref={componentRef} className="barcode-print" style={{padding: "20px"}}>
          ...
          <Grid item xs={12} align="center">
            <Button variant="contained" onClick={handlePrint} sx={{ mt: 2 }} disabled={!productName || !price || !category}>
              Print Barcode
            </Button>
          </Grid>
        </Grid>
